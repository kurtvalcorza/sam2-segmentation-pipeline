    ...
    "cells": [
        {
            ...
            "code": (
                ...
                "BYOD_MAX_TOTAL_PIXELS = 32 * 1024 * 1024\n\n"
                ...
                "            if total_pixels > BYOD_MAX_TOTAL_PIXELS:\n"
                "                raise ValueError('BYOD archive exceeds the total decoded pixel ceiling')\n"
        ...
        },
        {
            ...
            "code": (
                "import shutil\n\n"
                "artifact_dir = Path('outputs/sam2-mask-hypernetwork-adapter-v1')\n"
                "if artifact_dir.exists():\n"
                "    if not artifact_dir.is_dir():\n"
                "        raise RuntimeError(f'notebook-owned artifact path is not a directory: {{artifact_dir}}')\n"
                "    shutil.rmtree(artifact_dir)\n"
                "artifact_dir = pipe.save_artifact(artifact_dir, producer_revision=NOTEBOOK_SOURCE['repository_revision'])\n"
